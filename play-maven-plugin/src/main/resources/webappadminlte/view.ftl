<section class="content-header">
    <h1>
    ${functionShowName}
        <small>${functionShowName}</small>
        <input type="hidden" value="" id="${'${shortSimpleName}'?uncap_first}IdInput"
            ...
            <div class="box box-primary">
                ...
                <#list fields as field>
                    <#if field.formtype=="image">
                        <img alt="picture"
                             th:src="${r"${"}${'${shortSimpleName}'?uncap_first}==null?'':${'${shortSimpleName}'?uncap_first}.${field.fieldName}}"
