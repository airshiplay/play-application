...
public class ${shortSimpleName}Controller {
    ...
    @RequiresPermissions("page:${moduleName}:${shortSimpleName}:view")
    ...
    @RequiresPermissions("page:${moduleName}:${shortSimpleName}:create")
	@RequestMapping(value = { "/create.view" }, method = RequestMethod.GET)
	public String create(Model model) {
		return "classpath:/${moduleName}/${'${shortSimpleName}'?uncap_first}/${'${shortSimpleName}'?uncap_first}Form";
	}

    @RequiresPermissions("page:${moduleName}:${shortSimpleName}:edit")
