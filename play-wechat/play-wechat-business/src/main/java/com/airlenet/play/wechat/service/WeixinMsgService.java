...
import com.airlenet.play.wechat.entity.MessageType;
import com.airlenet.play.wechat.entity.QAttentionUserEntity;
import com.airlenet.play.wechat.entity.QCardCouponEntity;
import com.airlenet.play.wechat.entity.QCardCouponMemberEntity;
import com.airlenet.play.wechat.entity.QWechatMessageEntity;
...
public class WeixinMsgService extends WeixinService {
    ...
    public WexinMsgFactory.WechatMsgParent subscribeEvent(WexinMsgEventSubscribe msg) {
        if ("subscribe".equals(msg.getEvent())) {// 关注用户处理
            ...
            if (entity == null) {
                entity = new AttentionUserEntity();
    ...
    public WechatMsgParent handlerMessage(WechatConfigEntity config, WechatMsgParent msg, String body) {
        ...
        entity = new WechatMessageEntity();
        ...
        if (result != null) {
            WechatMessageEntity replyEntity = new WechatMessageEntity();
