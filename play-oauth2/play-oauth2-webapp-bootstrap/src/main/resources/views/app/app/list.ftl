                ...
                <div class="box-body no-padding">
                    <table id="grid-app" class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th data-column-id="platform" data-css-class="hidden-xs" data-header-css-class="hidden-xs">
                                平台
                            </th>
                            <th data-column-id="identifier" data-sortable="true" data-css-class="hidden-xs"
                                data-header-css-class="hidden-xs">标识
                            </th>
