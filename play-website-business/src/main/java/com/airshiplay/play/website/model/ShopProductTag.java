...
/**
 *
 * database table shop_product_tag
 *
 * @date do_not_delete_during_merge
 */
public class ShopProductTag implements Serializable {
    private Long id;
     ...
     * This field corresponds to the database table shop_product_tag
     *
     * @date
     */
    ...
    public boolean equals(Object that) {
        ...
        ShopProductTag other = (ShopProductTag) that;
