...
/**
 *
 * database table business_member_rank
 *
 * @date do_not_delete_during_merge
 */
public class BusinessMemberRank implements Serializable {
    private Long id;
     ...
     * This field corresponds to the database table business_member_rank
     *
     * @date
     */
    ...
    public boolean equals(Object that) {
        ...
        BusinessMemberRank other = (BusinessMemberRank) that;
