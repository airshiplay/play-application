...
/**
 * database table wechat_imgtext_item
 *
 * @date do_not_delete_during_merge
 */
public class WechatImgtextItem implements Serializable {
    private Long id;
     ...
     * This field corresponds to the database table wechat_imgtext_item
     *
     * @date
     */
    ...
    public boolean equals(Object that) {
        ...
        WechatImgtextItem other = (WechatImgtextItem) that;
