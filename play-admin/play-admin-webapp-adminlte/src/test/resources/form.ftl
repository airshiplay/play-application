...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#page/${module}/${'${shortClassName}'?uncap_first}/${'${shortClassName}'?uncap_first}List"><i
                class="glyphicon glyphicon-list"></i> ***列表</a></li>
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title" th:text="${r"${"}${'${shortClassName}'?uncap_first}==null?'新建***':'编辑***'}">
                        新建***</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" class="${'${shortClassName}'?lower_case}-form"
                      action="/${module}/${'${shortClassName}'?uncap_first}/save">
                    <input type="hidden" name="id"
                           th:value="${r"${"}${'${shortClassName}'?uncap_first}==null?'':${'${shortClassName}'?uncap_first}.id}"/>
                    <div class="box-body">
                    <#list fields as field>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="${field.fieldName}picker">
                                    ...
                                    <input type="text" class="form-control pull-right"
                                           name="${field.fieldName}" <#if field.notnull > data-bv-notempty="true"
                                           data-bv-notempty-message="请填写${field.fieldName}"</#if>
                                           th:value="${r"${"}${'${shortClassName}'?uncap_first}==null||${'${shortClassName}'?uncap_first}.${field.fieldName}==null?'': #dates.format(${'${shortClassName}'?uncap_first}.${field.fieldName}, 'yyyy年MM月dd日 HH:mm')}"/>
                                </div>
                            </div>
                        <#elseif field.fieldType="Enum">
                            <div class="form-group">
                                ...
                                <select id="${field.fieldName}Input" name="type"
                                        class="form-control" <#if field.notnull > data-bv-notempty="true"
                                        data-bv-notempty-message="请选择${field.fieldName}"</#if>
                        ...
                        <#else>
                            <div class="form-group">
                                ...
                                <input type="text" name="${field.fieldName}" class="form-control"
                                    ...
                                    <#if field.notnull > data-bv-notempty="true"
                    ...
                    <div class="box-footer">
                        <button type="button" class="btn btn-default"
                                onclick="location.href='#/page/${module}/${'${shortClassName}'?uncap_first}/${'${shortClassName}'?uncap_first}List'">
                            返回列表
                        </button>
