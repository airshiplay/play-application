            ...
            <div class="mailbox-controls">
                <div class="btn-group btn-group-sm">
                    <a type="button" class="btn btn-primary"
                       href="#/page/${module}/${'${shortClassName}'?uncap_first}/create">
                ...
                <div class="box-body no-padding">
                    <table id="grid-${'${shortClassName}'?lower_case}" class="table table-hover">
                        ...
                        <#list fields as field>
                            <th <#if field.fieldType=='Date'>data-column-id="${field.fieldName}" data-type="date"
                                <#else>data-column-id="${field.fieldName}" </#if>data-sortable="false" >${field.fieldName}</th>
                        </#list>
